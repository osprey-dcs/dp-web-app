 ...
 *
 * @generated from protobuf service DpQueryService
 */
export interface IDpQueryServiceClient {
     ...
     *
     * @generated from protobuf rpc: queryData(QueryDataRequest) returns (QueryDataResponse);
     */
     ...
     *
     * @generated from protobuf rpc: queryDataTable(QueryDataRequest) returns (QueryTableResponse);
     */
     ...
     *
     * @generated from protobuf rpc: queryDataStream(QueryDataRequest) returns (stream QueryDataResponse);
     */
     ...
     * contains the data matching the query specification.
     *
     * @generated from protobuf rpc: queryDataBidiStream(stream QueryDataRequest) returns (stream QueryDataResponse);
     */
     ...
     *
     * @generated from protobuf rpc: queryMetadata(QueryMetadataRequest) returns (QueryMetadataResponse);
     */
     ...
     *
     * @generated from protobuf rpc: queryAnnotations(QueryAnnotationsRequest) returns (QueryAnnotationsResponse);
     */
